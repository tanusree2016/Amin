        ...
        return (
            ...
            <div>
                <>
                    ...
                    <div style={{ height: "15px" }} onClick={this.show('medium')}>Expenses Category&nbsp;<Icon name="plus" /></div>
                    ...
                    <Modal size={size} open={open} onClose={this.close}>
                        ...
                        <Modal.Content>
                            ...
                            <Form.Field>
                                    <label>Name</label>
                                    <input placeholder="Enter project title here" name="project_title" value={this.state.project_title} onChange={this.handleChange} />
                                </Form.Field>
...
export default connect(mapStateToProps)(IncomeModal);
