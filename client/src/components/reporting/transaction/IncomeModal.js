...
class IncomeModal extends Component {
    ...
    handleSubmit = (event) => {
        ...
        let addTransaction = {
            ...
            incomecategory: parseInt(this.state.incomecategory),
        ...
        return (
            ...
            <div>
                <>
                    ...
                    <Button onClick={this.show('medium')}>Income &nbsp; <Icon size="small" name="plus" /></Button>
...
export default connect(mapStateToProps, { addTransaction })(IncomeModal);
