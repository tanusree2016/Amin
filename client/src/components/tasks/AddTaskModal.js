...
import AddTaskDate from '../calendar/AddTaskDate'
import PropTypes from 'prop-types';

import { connect } from 'react-redux';
import { addTask } from '../calendar/taskevent/TaskApi'
const options = [
        ...
        return (
            ...
            <div>
                <>
                    ...
                    <div onClick={this.show('medium')}>Add Task</div>
                    ...
                    <Modal.Content>
                            ...
                            <Button variant="secondary" disabled={!(this.state.body)} type="submit" style={{ float: "right", marginRight: "30px", background: "#e9768d" }}>
                                    Create
                            </Button>
