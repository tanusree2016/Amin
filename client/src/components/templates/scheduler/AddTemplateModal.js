...
import { Dropdown, Divider, Modal, Button, Icon } from 'semantic-ui-react'
        ...
        return (
            ...
            <div>
                <>
                    ...
                    <Button onClick={this.show('medium')}>Add Template</Button>

                    <Modal size={size} open={open} onClose={this.close}>
                        <Modal.Header>      New Scheduler
                            <Button variant="secondary" onClick={this.close} style={{ float: "right", background: "none" }}>
                                <Icon name="close" />
                            </Button></Modal.Header>
                        <Modal.Content>
