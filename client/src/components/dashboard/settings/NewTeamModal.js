        ...
        return (
            ...
            <div>
                <>
                    ...
                    <Button secondary onClick={() => this.handleShow(true)}>New Team</Button>
                        ...
                        <Modal.Body>
                            ...
                            <Form onSubmit={this.handleSubmit} >
                                <Form.Group controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="text" placeholder="Name" name="project_title" value={this.state.project_title} onChange={this.handleChange} required />
                                ...
                                <Form.Group controlId="formBasicPassword">
                                    ...
                                    <Form.Label><b>Members</b></Form.Label>
                                    <Form.Control type="text" placeholder="Members" name="project_title" value={this.state.project_title} onChange={this.handleChange} required />
                                ...
                                <Button onClick={() => this.handleShow(false)} style={{ float: "right" ,background:"white",border:"1ps solid grey",color:"black"}}>
                                    Cancel
                            </Button>&nbsp;
                            <Button variant="secondary" disabled={!(this.state.project_title)} type="submit" style={{ float: "right", marginRight: "30px",}}>
                                    Save
                            </Button>
