...
import { Modal,Button, Dropdown, Divider, Form, Input, Select, Label, Icon } from 'semantic-ui-react'
        ...
        return (
            ...
            <div  >
                <>
                    ...
                    {/* <Button color='#eee' style={{ border: "1px solid #aaa" }} onClick={() => this.handleShow(true)}>New Due Date</Button> */}
                    <Icon name="cog" onClick={() => this.handleShow(true)} />
                    <Modal
                        size="lg"
                        ...
                        <Modal.Body>
                            <div style={{ width: "500px", padding: "10px" }}>
                                ...
                                <Form onSubmit={this.handleSubmit} >
                                    ...
                                    <Button secondary disabled={(this.state.tag)} onClick={() => this.handleShow(false)} style={{ float: "right" }}>
                                        Cancel
                            </Button>&nbsp;
